const t=`# Datasources: https://query.wikidata.org/sparql
...
} GROUP BY ?use_type ?use_typeLabel ?compound ?compoundLabel ?ec_number ?cas_number ORDER BY ?avg_ld50 # rank by toxicity`;export{t as default};
